                            ...
                            <td class="px-3 py-4">
                                <div class="dropdown relative inline-flex [--auto-close:true] rtl:[--placement:bottom-end]">
                                    ...
                                    <ul class="dropdown-menu dropdown-open:opacity-100 hidden min-w-40 py-2 rounded-12px border border-d9 bg-white shadow-xl z-20">
                                        <li><a href="#" class="dropdown-item px-4 py-2.5 font-medium text-14px text-primary">فاتورة</a></li>
                                        <li><a href="#" class="dropdown-item px-4 py-2.5 font-medium text-14px text-red-500">استرداد</a></li>
                                    </ul>
                                </div>
                            </td>
                        </tr>
