                ...
                <table class="table w-full text-14px">
                    ...
                    @foreach ($roles as $r)
                        <tr class="border-b border-d9 last:border-0">
                            ...
                            <td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-role-'.$r->id, 'items' => [['label' => 'حذف', 'action' => route('panel.v1.admin.system.roles.delete',['id'=>$r->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                <table class="table w-full text-14px">
                    ...
                    @foreach ($groups as $g)
                        <tr class="border-b border-d9 last:border-0">
                            ...
                            <td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-group-'.$g->id, 'items' => [['label' => 'حذف', 'action' => route('panel.v1.admin.system.groups.delete',['id'=>$g->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                <table class="table w-full text-14px">
                    ...
                    @foreach ($deletes as $d)
                        <tr class="border-b border-d9 last:border-0">
                            ...
                            <td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-delreq-'.$d->id, 'items' => [['label' => 'تنفيذ', 'action' => route('panel.v1.admin.system.delete-requests.confirm',['id'=>$d->id]), 'confirm' => 'تنفيذ حذف الحساب؟', 'tone' => 'success'], ['label' => 'رفض', 'action' => route('panel.v1.admin.system.delete-requests.reject',['id'=>$d->id]), 'tone' => 'danger']]])</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                <table class="table w-full text-14px">
                    ...
                    @foreach ($reports as $rep)
                        <tr class="border-b border-d9 last:border-0">
                            ...
                            <td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-report-'.$rep->id, 'items' => [['label' => 'حذف', 'action' => route('panel.v1.admin.system.reports.delete',['id'=>$rep->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                <table class="table w-full text-14px">
                    ...
                    @foreach ($contacts as $co)
                        <tr class="border-b border-d9 last:border-0">
                            ...
                            <td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-contact-'.$co->id, 'items' => [['label' => 'حذف', 'action' => route('panel.v1.admin.system.contacts.delete',['id'=>$co->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                <table class="table w-full text-14px">
                    ...
                    @foreach ($consultations as $con)
                        <tr class="border-b border-d9 last:border-0">
                            ...
                            <td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-consult-'.$con->id, 'items' => [['label' => 'إنهاء', 'action' => route('panel.v1.admin.system.consultations.finish',['id'=>$con->id]), 'tone' => 'success'], ['label' => 'إلغاء', 'action' => route('panel.v1.admin.system.consultations.cancel',['id'=>$con->id]), 'confirm' => 'إلغاء الموعد مع الاسترداد؟', 'tone' => 'danger'], ['label' => 'حذف', 'action' => route('panel.v1.admin.system.consultations.delete',['id'=>$con->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                <table class="table w-full text-14px">
                    ...
                    @foreach ($forums as $f)
                        <tr class="border-b border-d9 last:border-0">
                            ...
                            <td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-forum-'.$f->id, 'items' => [['label' => 'تعديل', 'url' => route('panel.v1.admin.system.forums.edit',['id'=>$f->id]), 'tone' => 'gray'], ['label' => 'حذف', 'action' => route('panel.v1.admin.system.forums.delete',['id'=>$f->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
                ...
                <table class="table w-full text-14px">
                    ...
                    @foreach ($notifications as $n)
                        <tr class="border-b border-d9 last:border-0">
                            ...
                            <td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-notif-'.$n->id, 'items' => [['label' => 'حذف', 'action' => route('panel.v1.admin.system.notifications.delete',['id'=>$n->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
    ...
    @if (!empty($supportDepartments) && $supportDepartments->count())
        <div class="border border-d9 rounded-14px bg-white overflow-hidden">
            ...
            <div class="overflow-x-auto"><table class="table w-full text-14px"><thead><tr class="bg-fa border-b border-d9 text-gray"><th class="px-4 py-3 text-start">العنوان</th><th class="px-4 py-3 text-center">الأيقونة</th><th class="px-4 py-3 text-center">إجراءات</th></tr></thead><tbody>
                @foreach($supportDepartments as $d)<tr class="border-b border-d9 last:border-0"><td class="px-4 py-3 font-bold text-primary">{{ $d->title ?? 'قسم #'.$d->id }}</td><td class="px-4 py-3 text-center"><span class="{{ $d->icon ?? 'icon-[tabler--headset]' }} size-5 text-primary inline-block"></span></td><td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-supdept-'.$d->id, 'items' => [['label' => 'تعديل', 'url' => route('panel.v1.admin.system.support-departments.edit',['id'=>$d->id]), 'tone' => 'gray'], ['label' => 'حذف', 'action' => route('panel.v1.admin.system.support-departments.delete',['id'=>$d->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td></tr>@endforeach
            </tbody></table></div>
        </div>
    @endif
    ...
    @if (!empty($notificationTemplates) && $notificationTemplates->count())
        <div class="border border-d9 rounded-14px bg-white overflow-hidden">
            ...
            <div class="overflow-x-auto"><table class="table w-full text-14px"><thead><tr class="bg-fa border-b border-d9 text-gray"><th class="px-4 py-3 text-start">العنوان</th><th class="px-4 py-3 text-center">إجراءات</th></tr></thead><tbody>
                @foreach($notificationTemplates as $t)<tr class="border-b border-d9 last:border-0"><td class="px-4 py-3 font-bold text-primary truncate max-w-[24rem]">{{ $t->title }}</td><td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-ntpl-'.$t->id, 'items' => [['label' => 'تعديل', 'url' => route('panel.v1.admin.system.notification-templates.edit',['id'=>$t->id]), 'tone' => 'gray'], ['label' => 'حذف', 'action' => route('panel.v1.admin.system.notification-templates.delete',['id'=>$t->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td></tr>@endforeach
            </tbody></table></div>
        </div>
    @endif
    ...
    @if (!empty($regions) && $regions->count())
        <div class="border border-d9 rounded-14px bg-white overflow-hidden">
            ...
            <div class="overflow-x-auto"><table class="table w-full text-14px"><thead><tr class="bg-fa border-b border-d9 text-gray"><th class="px-4 py-3 text-start">الاسم</th><th class="px-4 py-3 text-center">النوع</th><th class="px-4 py-3 text-center">إجراء</th></tr></thead><tbody>
                @foreach($regions as $r)<tr class="border-b border-d9 last:border-0"><td class="px-4 py-3 font-bold text-primary">{{ $r->title ?? 'منطقة #'.$r->id }}</td><td class="px-4 py-3 text-center font-medium text-gray">{{ $r->type ?? '—' }}</td><td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-region-'.$r->id, 'items' => [['label' => 'حذف', 'action' => route('panel.v1.admin.system.regions.delete',['id'=>$r->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td></tr>@endforeach
            </tbody></table></div>
        </div>
    @endif
    ...
    @if (!empty($forumTopics) && $forumTopics->count())
        <div class="border border-d9 rounded-14px bg-white overflow-hidden">
            ...
            <div class="overflow-x-auto"><table class="table w-full text-14px"><thead><tr class="bg-fa border-b border-d9 text-gray"><th class="px-4 py-3 text-start">الموضوع</th><th class="px-4 py-3 text-center">المنتدى</th><th class="px-4 py-3 text-center">الكاتب</th><th class="px-4 py-3 text-center">التاريخ</th><th class="px-4 py-3 text-center">إجراء</th></tr></thead><tbody>
                @foreach($forumTopics as $t)<tr class="border-b border-d9 last:border-0"><td class="px-4 py-3 font-bold text-primary truncate max-w-[16rem]">{{ $t->title }}</td><td class="px-4 py-3 text-center font-medium text-gray">{{ $t->forum->title ?? '—' }}</td><td class="px-4 py-3 text-center font-medium text-gray">{{ $t->creator->full_name ?? '—' }}</td><td class="px-4 py-3 text-center font-medium text-gray">{{ date('Y/m/d',(int)$t->created_at) }}</td><td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-ftopic-'.$t->id, 'items' => [['label' => 'حذف', 'action' => route('panel.v1.admin.system.forum-topics.delete',['id'=>$t->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td></tr>@endforeach
            </tbody></table></div>
        </div>
    @endif
    ...
    @if (!empty($forumReports) && $forumReports->count())
        <div class="border border-d9 rounded-14px bg-white overflow-hidden">
            ...
            <div class="overflow-x-auto"><table class="table w-full text-14px"><thead><tr class="bg-fa border-b border-d9 text-gray"><th class="px-4 py-3 text-start">#</th><th class="px-4 py-3 text-start">المُبلغ</th><th class="px-4 py-3 text-center">التاريخ</th><th class="px-4 py-3 text-center">إجراء</th></tr></thead><tbody>
                @foreach($forumReports as $r)<tr class="border-b border-d9 last:border-0"><td class="px-4 py-3 font-bold text-primary">#{{ $r->id }}</td><td class="px-4 py-3 font-medium text-primary">{{ $r->user->full_name ?? 'مستخدم #'.$r->user_id }}</td><td class="px-4 py-3 text-center font-medium text-gray">{{ date('Y/m/d',(int)$r->created_at) }}</td><td class="px-4 py-3 text-center">@include('panel_v1.components.actions-dropdown', ['id' => 'sys-freport-'.$r->id, 'items' => [['label' => 'حذف', 'action' => route('panel.v1.admin.system.forum-reports.delete',['id'=>$r->id]), 'confirm' => 'حذف؟', 'tone' => 'danger']]])</td></tr>@endforeach
            </tbody></table></div>
        </div>
    @endif
