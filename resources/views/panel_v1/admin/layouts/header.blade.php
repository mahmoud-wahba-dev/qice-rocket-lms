@php
    ...
    $userName = $authUser->full_name ?? ($authUser->name ?? 'المسؤول');
@endphp

<header class="panel-v1-panel-header">
    <div class="panel-v1-panel-header__actions">
        <button type="button" class="panel-v1-btn panel-v1-btn--primary">لوحة التعليم والأكاديميات ▾</button>
    </div>
    <div class="panel-v1-panel-header__user">
        ...
        <button type="button" class="panel-v1-icon-btn" aria-label="اللغة">لغة</button>
