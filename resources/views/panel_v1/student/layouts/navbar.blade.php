            ...
            <div class="flex items-center gap-3 md:gap-4">
                ...
                @auth
                    ...
                    <div class="dropdown relative inline-flex [--auto-close:inside] rtl:[--placement:bottom-end]">
                        <button id="student-notifications-toggle" type="button"
                            class="dropdown-toggle btn btn-text max-xl:px-1 relative"
                        ...
                        <div class="dropdown-menu dropdown-open:opacity-100 hidden w-[22rem] max-w-[calc(100vw-2rem)] p-0 rounded-16px border border-d9 shadow-[0_12px_40px_rgba(15,76,69,0.12)] bg-white overflow-hidden"
                            role="menu" aria-orientation="vertical" aria-labelledby="student-notifications-toggle">
...
{{-- Toast Notification — last in DOM, above overlays/modals --}}
<div id="cart-toast"
    ...
    <button type="button" onclick="hideCartToast()" class="ms-auto text-primary/40 hover:text-primary transition" aria-label="إغلاق">
