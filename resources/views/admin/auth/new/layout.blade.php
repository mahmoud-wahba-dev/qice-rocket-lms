    ...
    <div class="admin-auth-pages">
        ...
        <div class="admin-auth-pages__contents px-16 px-lg-0">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="ml-8">
                    <h5 class="font-14">مركز الجودة والتميز V2.1</h5>
                    <a href="https://codecanyon.net/user/rocketsoft/portfolio" class="font-12 text-gray-500 mt-4">All rights reserved for مركز الجودة والتميز V2.1</a>
                </div>
            </div>
